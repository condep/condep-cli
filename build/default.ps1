...
task Create-BuildSpec-ConDep-Console {
	Generate-Nuspec-File `
		...
		-dependencies @(
			@{ Name="ConDep.Dsl"; Version="[5.0.1-beta0001,6)"},
			@{ Name="ConDep.Execution"; Version="[5.0.1-beta0001,6)"},
			@{ Name="ConDep.Dsl.Operations"; Version="[5.0.1-beta0001,6)"},
			@{ Name="ConDep.Dsl.Remote.Helpers"; Version="[5.0.1-beta0001,6)"},
			@{ Name="ConDep.Node"; Version="[5.0.1-beta0001,6)"},
