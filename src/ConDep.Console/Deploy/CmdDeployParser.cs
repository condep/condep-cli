            ...
            _optionSet = new OptionSet()
                {
                    ...
                    {"apiTimeout=", "Timeout in milliseconds before calls to the ConDep server api (ConDep Node) will time out (default is 100 seconds).", v => _options.ApiTimout = Convert.ToInt32(v) }
                };
